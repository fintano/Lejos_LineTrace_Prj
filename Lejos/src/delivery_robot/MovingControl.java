...
//			result = in.read(Data, 0,Math.min(0, in.available()) );
			
//			if(result==-1) Data[0]=-1;
			
			/*
			 * Check input Data from user android
			 */
			/*System.out.println("TEST2" + Data[0]);
			*/
